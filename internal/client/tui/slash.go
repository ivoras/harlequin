...
var slashCommands = []string{
	"/alert", "/clear", "/config", "/context", "/cron", "/dismiss", "/docs", "/export", "/hat", "/help", "/mcp",
...
var slashHelp = map[string]string{
	...
	"/docs":    "documents: /docs search <q> | list | del <scope> <id> | view <scope> <id>|<p|u|s>.<id> [text|file] | add [scope] <path>",
	...
	"/project": "manage projects (list/new/switch/invite/assign/leave/depart); switch/depart accept a project id or name",
